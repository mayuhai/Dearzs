...
public final class Logger {
	 ...
	 */
	private static String TAG = "DearZs";
	...
	public static void d(String tag, String message, String title) {
		d(tag, message, settings.methodCount, title);
	}

	public static void d(String tag, String message, int methodCount,
			String title) {
		validateMethodCount(methodCount);
		log(Log.DEBUG, tag, message, methodCount, title);
	}
	...
	private static void log(int logType, String tag, String message,
			int methodCount, String title) {
		if (settings.logLevel == LogLevel.NONE) {
			return;
		}
		logTopBorder(logType, tag);
		logHeaderContent(logType, tag, methodCount, title);
	...
	private static void logHeaderContent(int logType, String tag,
		...
		if (title != null && !"".equals(title)) {
			logChunk(logType, tag, HORIZONTAL_DOUBLE_LINE + title);
			logDivider(logType, tag);
		}
