 ...
 * 左侧有图片
 */
public class CustomCellViewWithImage extends LinearLayout {
    /**
     * 默认资源ID
     **/
    ...
    public CustomCellViewWithImage(Context context) {
        super(context);
        mContext = context;
    }

    public CustomCellViewWithImage(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView(attrs);
    }
    ...
    private void initView(AttributeSet attrs) {
        ...
        mLayoutCell = (ViewGroup) mInflater.inflate(R.layout.custom_cell_layout_with_image, this);
...
//            showTopLine = a.getBoolean(R.styleable.CustomCellViewStyle_cShowTopLine, true);
            ...
            rightresId = a.getResourceId(R.styleable.CustomCellViewStyle_cRightResId, DEFAULT_RES_ID);
...
//    }
     ...
     * @param rightresId
     */
    public void setRightIconImage(int rightresId) {
        if (rightresId == DEFAULT_RES_ID || rightresId < 0) {
            rightresId = R.mipmap.ic_arrow_right;
        }
        mIvDesc.setImageResource(rightresId);
    }
