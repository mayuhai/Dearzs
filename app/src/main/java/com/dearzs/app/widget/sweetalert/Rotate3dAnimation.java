...
public class Rotate3dAnimation extends Animation {
    ...
    private MyDescription parseValue(TypedValue value) {
        MyDescription d = new MyDescription();
        if (value == null) {
            d.type = ABSOLUTE;
            d.value = 0;
        } else {
    ...
    public Rotate3dAnimation (Context context, AttributeSet attrs) {
        ...
        MyDescription d = parseValue(a.peekValue(R.styleable.Rotate3dAnimation_pivotX));
        mPivotXType = d.type;
