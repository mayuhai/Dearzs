...
public class BaseAdapterHelper {
    ...
    protected BaseAdapterHelper(Context context, ViewGroup parent,
        ...
        if(parent instanceof ListView) {
            this.parentView = (ListView) parent;
        }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setHtmlText(int viewId, String htmlVal) {
        TextView view = retrieveView(viewId);
        view.setText(Html.fromHtml(htmlVal));
        return this;
    }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setTopDrawable(int viewId, int resId) {
        TextView view = retrieveView(viewId);

        Drawable topDrawable = context.getResources().getDrawable(resId);
    ...
    /**
     * get a view visibility state to VISIBLE (true) or GONE (false).
     * @param viewId  The view id.
     * @return The BaseAdapterHelper for chaining.
     */
